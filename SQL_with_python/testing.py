...
def delete():
    ...
    orderid= "199673"
    sql_delete = "delete from shopper_orders where order_id = ?"
...
# delete from shopper_orders where order_date > '2022-00-00'
# delete from shopprt_orders where order_id = "199673"
...
def fetchall(shopperid):
    ...
    for row in all_rows:
            ...
            c = c + 1
    db.close()
displaying_basket(10000)
fetchall(10000)


newone= "/Users/boldizsarbanfia/Documents/Coding/assessments/database/Assessment.db"
oldone= "/Users/boldizsarbanfia/Documents/University/Database/Assessment/Database/Assessment.db"