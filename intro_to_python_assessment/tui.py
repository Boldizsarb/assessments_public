...
def welcome():
    ...
    """
    # TODO: Your code here
    welcome_massage = "COVID-19 (January)"
    print("-" * len(welcome_massage))
...
def progress(operation, value):
    ...
    print()
    if value < 100:
        print(f"{operation} has started, is in progress {value} % completed")
    elif value >= 100:
...
def menu(variant=0):
    ...
    if variant == 0 or variant == None: # not sure if the none works
       ...
       # chosen_menu = int(input())
        #if chosen_menu == 1:
         #   print(" Displaying Serial Number(s)")
     #   elif chosen_menu == 2:
         #   print("Displaying Observation date:")
      #  elif chosen_menu == 3:
        #    print("Displaying Group records by Country/Region...")
        #elif chosen_menu == 4:
    #        print("Summerising Records...")
      #  else:
        #    print("Please select from the list above!")

    elif variant == 2:
        print("Please select from the following:")
        print("\n[1] Country/Region Pie Chart\n", "[2] Observations Chart\n", "[3] Animated Summary\n", "[4]Barchart Cases by Country/Region\n")
        """chosen_menu = int(input())
        if chosen_menu == 1:
            print("Displaying Country/Region Pie Chart...")
        elif chosen_menu == 2:
            print("Displaying Observation Chart...")
        elif chosen_menu == 3:
            print("Displaying Animated Summary...")
        else:
            print("Please select from the list above!")"""
        ...
        if chosen_menu == 1:
            ...
            print(" Displaying Data for Specific Country/Region")
        else:
            print("Please select from the list above!")"""

    elif variant > 3:
        print("Invalid option, Please select between 0 and 4!")
        return 0

    else:
        print("Error! The chosen menu does not exist!")

    #response = int(input()) -> not if this is needed
    return int(input())
...
def serial_number():
    ...
    """
    # TODO: Your code here
    print("Please Enter the serial number of a record!")
    seriar_num = int(input())
    return seriar_num
...
def observation_dates():
    ...
    """
    # TODO: Your code here
    print("Please enter observation dates.")
    print("Please follow the example: mm/dd/yyyy")
    #print("Should you write multiple dates, place a coma inbetween\n and only press enter when you done.")
    input_dates = []
    user_answer = input()
    input_dates.append(user_answer)
    return input_dates
